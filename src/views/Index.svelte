  ...
  <div class="container mx-auto items-center flex flex-wrap">
    <div class="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
      <div class="pt-32 sm:pt-0">
        <h2 class="font-medium text-4xl text-gray-700">
          Welcome to <span class="font-bold">AmslerTouch</span>
        </h2>
        <p class="mt-4 text-lg leading-relaxed text-gray-600">
          AmslerTouch is an interactive, touch-based AMD testing app.<br><br>
          It aims to support self-reported, quantitative report of those suffering from AMD (Age-related macular degeneration).<br><br>
          AmslerTouch is developed by <a href="https://donghoon.io" class="text-gray-700" target="_blank">Donghoon Shin</a> for his B.S. thesis, which is advised by Jongmo Seo.
        </p>
        <div class="mt-12">
          <a
            href="landing"
            class="get-started text-white font-bold px-6 py-4 rounded outline-none focus:outline-none mr-1 mb-1 bg-red-500 active:bg-red-600 text-sm shadow hover:shadow-lg ease-linear transition-all duration-150"
          >
            Click here to try AmslerTouch
          </a>
        </div>
      </div>
    </div>
