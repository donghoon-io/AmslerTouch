<script>
  ...
  function nextPage() {
    consent = !consent;
    document.getElementById('consent').disabled = !consent;
  }
</script>
            ...
            >
              <div class="flex-auto p-5 lg:p-10">
                ...
                <p class="leading-relaxed mt-1 mb-4 text-gray-600">
                  In order to use AmslerTouch, you must fill out the form.<br>
                  Once you submit, you are considered to agree with our terms of usage.
                </p>
                ...
                <div class="relative w-full mb-3">
                  <label class="flex items-center">
                    <input type="checkbox" class="form-checkbox" on:click={nextPage}>
                    <span class="ml-2">I agree to the <span class="underline">privacy policy</span></span>
                  </label>
                </div>
                <div class="text-center mt-6">
                  <button id="consent" disabled={consent}
